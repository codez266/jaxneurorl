...
class RnnAgent(nn.Module):
    ...
    def sfgpi(self,
        ...
        def compute_sf_q(sf_input: jnp.ndarray,
            ...
            # [N, A * C]
            sf = jnp.array([self.sf_nets[idx](sf_input) for idx in range(self.tasks)])
            # [N, A, C]
            sf = jnp.reshape(sf, (self.tasks, self.num_actions, self.state_features_dim))
